...
#upload a file from a guest on a esxi host
#original file is from the pyvmomi examples
#tested with esxi 6
#added a small workaround for url when uploading file, see below
...
def main():
    ...
    try:
        ...
        try:
            ...
            #ds: workaround for wrong url
            url2=url.replace ('*', horst)
            
            resp = requests.put(url2, data=args, verify=False)
