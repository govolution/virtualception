#ds: original file is from the pyvmomi examples
#see virtualception.wordpress.com
#execute a program in a guest on a esxi host
#tested with esxi 6, guest windows and linux
#only small changes
#old comment:
"""
